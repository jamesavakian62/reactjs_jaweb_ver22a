...
const Apps = () => {
  ...
  const [faqs, setFaqs] = useState([
    {
      question: "Mobile Apps are compiled and found on Apple App Store?",
      answer: `All of our Responsive Website Designs, RWD, are size adjustable to read and use
      easily.  The ReactJS websites are either CSS3, Bootstrap, or TailwindCSS
      and fully accessable by computer, tablet, and cell phone.  The ReactJS
